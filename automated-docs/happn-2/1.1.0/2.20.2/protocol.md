...
###HAPPN VERSION: 2.20.2
####RUN DATE: 2017 June 05 02:22
#connect a client

###create a client session and login

(existing client with session id: 1bb67676-479f-4ef5-8797-d07c80118086 was already created) ##DIFF_IGNORE
###client -> server
```json
{
  "action": "describe",
...
```json
{
  ...
  "_meta": {
    "created": "{{number, utc}}",
    "modified": "{{number, utc}}",
    "path": "/_TAGStag/non-existent/ad03530e478b4b5fbc87a82f505c3948",
    "tag": "MYTAG",
    "type": "response",
    "status": "ok",
    "published": true,
