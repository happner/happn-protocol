...
###HAPPN VERSION: 4.0.0
####RUN: 2017 November 09 12:00
#connect a client

###create a client session and login

(existing client with session id: e715b017-8dcb-4b35-88d8-009f4d4ecc2b was already created) ##DIFF_IGNORE
###client -> server
```json
{
...
```json
{
  ...
  "_meta": {
    "created": "{{number, utc}}",
    "modified": "{{number, utc}}",
    "path": "/_TAGS/tag/non-existent/u3WATH6NQ4KHjFYyOks36g-1",
    "tag": "MYTAG",
    "published": true,
    "type": "response",
    "status": "ok",
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "366d570f-251d-465b-9588-fd1c94c162fd-18"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "366d570f-251d-465b-9588-fd1c94c162fd-21"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "366d570f-251d-465b-9588-fd1c94c162fd-24"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "366d570f-251d-465b-9588-fd1c94c162fd-26"
  },
  "__outbound": true
}
```
...
one connected client remaining, so disconnect warning is sent to it, session id (matches the one stipulated in section 1_1) is:e715b017-8dcb-4b35-88d8-009f4d4ecc2b  ##DIFF_IGNORE
###server -> client
```json
{
  "_meta": {
...
####RUN: 2017 November 09 12:10
#connect a client

###create a client session and login

(existing client with session id: b98abc5d-72f9-48b3-902f-90bb9475732d was already created) ##DIFF_IGNORE
###client -> server
```json
{
  "action": "configure-session",
...
```json
{
  "data": {
    ...
    "timestamp": "{{number, utc}}",
    "isEncrypted": false,
    "origin": "fortunetwister_N1No_faAm",
    "policy": {
      "0": {
        "ttl": 0,
        "inactivity_threshold": null
...
```json
{
  ...
  "_meta": {
    "created": "{{number, utc}}",
    "modified": "{{number, utc}}",
    "path": "/_TAGS/tag/non-existent/GQBpNuUlT_2Yn7ZhnFYdBw-1",
    "tag": "MYTAG",
    "published": true,
    "type": "response",
    "status": "ok",
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "77c63e66-fc73-4317-8a4f-aa1592215b47-15"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "77c63e66-fc73-4317-8a4f-aa1592215b47-18"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "77c63e66-fc73-4317-8a4f-aa1592215b47-21"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "77c63e66-fc73-4317-8a4f-aa1592215b47-23"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "sessionId": "{{guid}}",
  "options": {
    "referenceId": "t7SCXs9jT2GSYA3eDo3sMQ/3",
    "timeout": 60000
  }
}
```
...
one connected client remaining, so disconnect warning is sent to it, session id (matches the one stipulated in section 1_1) is:b98abc5d-72f9-48b3-902f-90bb9475732d  ##DIFF_IGNORE
###server -> client
```json
{
  "_meta": {
