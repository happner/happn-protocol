...
###HAPPN VERSION: 1.1.1
####RUN: 2016 December 22 11:03
#connect a client

###create a client session and login

(existing client with session id: 4f26b824-2891-4718-9442-2007472a94f6 was already created) ##DIFF_IGNORE
###client -> server
```json
{
...
one connected client remaining, so disconnect warning is sent to it, session id (matches the one stipulated in section 1_1) is:4f26b824-2891-4718-9442-2007472a94f6  ##DIFF_IGNORE
###server -> client
```json
{
  "_meta": {
...
####RUN: 2017 June 13 04:07
#connect a client

###create a client session and login

(existing client with session id: 60be94df-c9fd-4d81-bb10-52c006fb06e5 was already created) ##DIFF_IGNORE
###client -> server
```json
{
  "action": "configure-session",
...
```json
{
  ...
  "_meta": {
    "created": "{{number, utc}}",
    "modified": "{{number, utc}}",
    "path": "/_TAGS/tag/non-existent/1497362825611_f5d39695fbd04da599ed1f4e04d9b710",
    "tag": "MYTAG",
    "published": true,
    "type": "response",
    "status": "ok",
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "7acc522f-339f-46e1-8395-d1a15abff263-18"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "7acc522f-339f-46e1-8395-d1a15abff263-21"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "7acc522f-339f-46e1-8395-d1a15abff263-24"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "7acc522f-339f-46e1-8395-d1a15abff263-26"
  },
  "__outbound": true
}
```
...
one connected client remaining, so disconnect warning is sent to it, session id (matches the one stipulated in section 1_1) is:60be94df-c9fd-4d81-bb10-52c006fb06e5  ##DIFF_IGNORE
###server -> client
```json
{
  "_meta": {
