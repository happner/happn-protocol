...
####RUN: 2017 July 25 09:44
#connect a client

###create a client session and login

(existing client with session id: 41f0b6c4-dac4-42d2-8408-3303703041a7 was already created) ##DIFF_IGNORE
###client -> server
```json
{
...
```json
{
  ...
  "_meta": {
    "created": "{{number, utc}}",
    "modified": "{{number, utc}}",
    "path": "/_TAGS/tag/non-existent/1500968672287_853305f1334f4f8da5bf2a55661ca543",
    "tag": "MYTAG",
    "published": true,
    "type": "response",
    "status": "ok",
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "a44301f3-9664-4b94-9ccd-2c914f06bc05-18"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "a44301f3-9664-4b94-9ccd-2c914f06bc05-21"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "a44301f3-9664-4b94-9ccd-2c914f06bc05-24"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "a44301f3-9664-4b94-9ccd-2c914f06bc05-26"
  },
  "__outbound": true
}
```
...
one connected client remaining, so disconnect warning is sent to it, session id (matches the one stipulated in section 1_1) is:41f0b6c4-dac4-42d2-8408-3303703041a7  ##DIFF_IGNORE
###server -> client
```json
{
  "_meta": {
...
##PROTOCOL VERSION: 1.3.0
###HAPPN VERSION: 3.0.0
####RUN: 2017 August 18 04:32
#connect a client

###create a client session and login

(existing client with session id: 3a9a7ca9-0fec-408a-ab91-2f36c74e875e was already created) ##DIFF_IGNORE
###client -> server
```json
{
  "action": "configure-session",
...
```json
{
  ...
  "_meta": {
    "created": "{{number, utc}}",
    "modified": "{{number, utc}}",
    "path": "/_TAGS/tag/non-existent/1503066725568_e358faf2a78640fe8c2c2819b2cfc162",
    "tag": "MYTAG",
    "published": true,
    "type": "response",
    "status": "ok",
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "58f45051-6a8e-4d82-8256-daa49215d884-18"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "58f45051-6a8e-4d82-8256-daa49215d884-21"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "58f45051-6a8e-4d82-8256-daa49215d884-24"
  },
  "__outbound": true
}
```
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "{{guid}}",
    "consistency": 2,
    "publicationId": "58f45051-6a8e-4d82-8256-daa49215d884-26"
  },
  "__outbound": true
}
```
...
one connected client remaining, so disconnect warning is sent to it, session id (matches the one stipulated in section 1_1) is:3a9a7ca9-0fec-408a-ab91-2f36c74e875e  ##DIFF_IGNORE
###server -> client
```json
{
  "_meta": {
